...
#
history_dict_do = model_fitted_do.history
acc_do = history_dict_do['accuracy']
acc_val_do = history_dict_do['val_accuracy']
loss_values_do = history_dict_do['loss']
loss_values_val_do = history_dict_do['val_loss']
# Graph
epochs = range(1, len(loss_values) + 1)
plt.plot(epochs, acc, 'bo', label='Training acc')
plt.plot(epochs, acc_val, 'b', label='Validation acc')    # 'b': solid blue line
plt.plot(epochs, acc_do, 'ro', label='Training acc (dropout)')
plt.plot(epochs, acc_val_do, 'r', label='Validation acc (dropout)')
...
plt.plot(epochs, loss_values_do, 'ro', label='Training loss (dropout)')
plt.plot(epochs, loss_values_val_do, 'r', label='Validation loss (dropout)')
